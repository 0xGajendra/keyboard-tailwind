        ...
        <div className="w-[50%] h-[40%] bg-neutral-800 rounded-2xl p-4 overflow-hidden selection:bg-gray-600 ">
          <div className="flex items-center h-1/7 gap-2 text-xs mb-2">
            ...
            <div className="px-2 bg-black rounded-lg h-full w-1/14 py-1.5 flex flex-col items-center justify-center text-xs shadow-2xl shadow-white inset-shadow-xs inset-shadow-white/40 ring-2 ring-white/50 hover:ring-1 hover:shadow-xl hover:scale-98 hover:shadow-white/15 transition-all duration-100 hover:cursor-pointer">
              <div className="size-6 rounded-full ring-gray-500 ring-2 "></div>
            </div>
          </div>
          <div className="flex items-center h-1/7 gap-2 text-xs mb-2">
            <div className="keyboard-button">
            ...
            <div className="keyboard-button">
              <span className="text-xs text-white/80">_</span>
              <span>-</span>
            </div>
            <div className="keyboard-button">
              <span className="text-xs text-white/80">+</span>
            ...
            <div className="key-button-sec flex items-center justify-end pr-2 pb-2 ">
              delete
            </div>
          </div>
          <div className="flex items-center h-1/7 gap-2 text-xs mb-2">
          ...
          <div className="flex items-center h-1/7 gap-2 text-xs mb-2">
            <div className="keyboard-button pl-2 pr-4 flex">
              <span className="pl-6">fn</span>
              <span className="pr-6">
                <Globe className="size-3" />
              </span>
            </div>
            <div className="keyboard-button pl-2 pr-4 flex text-2xs">
              <span className="pl-6">
            ...
            <div
              className="pt-6 bg-black rounded-lg h-full w-1/3 text-xs 
         shadow-2xl shadow-white ring-2 ring-white/50 
         transition-all duration-100 
         hover:ring-1 hover:shadow-xl hover:scale-95 hover:shadow-white/15 hover:cursor-pointer"
            >
              {""}
            </div>
         ...
         hover:ring-1 hover:shadow-xl hover:scale-95 hover:shadow-white/15 hover:cursor-pointer hover:overflow-hidden hover:bg-black/90"
            ...
            <div className="flex m-0 items-center justify-between flex-col  mt-2">
              <div
                className="px-8 bg-black rounded-lg h-full mb-2 w-1/14 py-1.5 flex flex-col items-center justify-between text-xs 
         shadow-2xl shadow-white ring-2 ring-white/50 
         transition-all duration-100
         hover:ring-1 hover:shadow-xl m-0 hover:scale-95 hover:shadow-white/15 hover:cursor-pointer hover:overflow-hidden hover:bg-black/90"
              >
